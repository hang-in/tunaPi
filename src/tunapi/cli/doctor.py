...
from ..settings import TunapiSettings, TelegramTopicsSettings, TelegramTransportSettings
...
def run_doctor(
    *,
    ...
    if settings.transport != "telegram":
        typer.echo(
            "error: tunapi doctor currently supports the telegram transport only.",
            err=True,
        )
